...
activities = {
    ...
    "Soccer Team": {
        "description": "Develop teamwork and compete in seasonal soccer matches",
        "schedule": "Mondays, Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["maria@mergington.edu", "alex@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice basketball drills and play friendly games",
    ...
    "Debate Team": {
        "description": "Improve public speaking and argumentation skills",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 12,
        "participants": ["felix@mergington.edu", "lara@mergington.edu"]
    }
}
